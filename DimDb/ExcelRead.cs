...
namespace DimDb
{
    public class ExcelRead
    {
        ...
        public void ReadandWrite()
        {
            ...
            string excelFilePath = @"C:\Users\ASUS\Desktop\DimProject\SonButovCedvel.xlsx";
            ExcelPackage.LicenseContext = LicenseContext.NonCommercial;
            string columnName = "VÖEN";
            ...
            using (var package = new ExcelPackage(new FileInfo(excelFilePath)))
            {
                ...
                SqlTransaction sqlTransaction = ConnectionDB.connect.BeginTransaction();
